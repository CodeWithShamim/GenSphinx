        ...
        <AnimatePresence mode="wait">
          {isLoadingRiddle ? (
            ...
            >
              ...
              <p className="text-muted-foreground font-medium animate-pulse italic">Consulting the digital oracle...</p>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground max-w-xs mx-auto">Click below to summon a new riddle from the GenLayer AI.</p>
                </div>
              </div>
              <Button 
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                      <AddressDisplay address={entry.address} maxLength={6} className="font-bold text-white/90" />
                      {address?.toLowerCase() === entry.address?.toLowerCase() && (
                        <div className="text-[10px] text-accent font-bold uppercase tracking-tighter">You</div>
                      )}
                    </div>
                  </div>
                  <div className="flex flex-col items-end">
                    <span className="text-2xl font-black text-accent">{entry.points}</span>
                    <span className="text-[10px] uppercase tracking-widest text-white/30 font-bold">Points</span>
                  </div>
